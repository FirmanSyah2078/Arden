...
export default function MobilePage() {
  ...
  return (
    <div className="absolute inset-0 flex h-full w-full flex-col overflow-hidden bg-[#151419] px-5 pt-4 font-sans">
      ...
      <HelpGuide isOpen={isHelpOpen} setIsOpen={setIsHelpOpen} />

      <EditProfile isOpen={isProfileOpen} setIsOpen={setIsProfileOpen} />
    </div>
  )
}
