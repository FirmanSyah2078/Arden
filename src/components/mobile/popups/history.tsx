        ...
        <ul className="flex flex-col gap-2 w-full pb-2">
          {isLoadingHistory ? (
            ...
            historyData.map((item, idx) => (
              <li
                key={idx}
                className="w-full bg-white/[0.03] border border-white/5 rounded-2xl p-3 flex items-center justify-between gap-3 transition-all active:scale-[0.98] group hover:border-white/10"
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-8 h-8 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-[10px] font-bold text-white/70 shrink-0 group-hover:bg-white/20 transition-colors">
                ...
                <div className="flex flex-col items-end gap-1 shrink-0">
                  <div className="font-mono text-[10px] font-bold text-white bg-white/10 px-2 py-0.5 rounded-md border border-white/20">
            ...
            <div className="flex flex-col items-center justify-center h-40 text-white/20 bg-white/[0.03] border border-white/5 rounded-3xl border-dashed">
