...
export const BottomDock = ({
  ...
  return (
    <div className="relative w-full flex justify-center items-center pt-4 pb-6 z-50 transition-all duration-500 ease-in-out animate-in fade-in slide-in-from-bottom-4 fill-mode-both">
